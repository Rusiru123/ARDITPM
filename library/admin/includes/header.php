                    ...
                    <div class="navbar-collapse collapse ">
                        <ul id="menu-top" class="nav navbar-nav navbar-right">
                            ...
                            <li>
                               ...
                               <li>
                                <a href="#" class="dropdown-toggle" id="ddlmenuItem" data-toggle="dropdown"> Suppliers <i class="fa fa-angle-down"></i></a>
                                <ul class="dropdown-menu" role="menu" aria-labelledby="ddlmenuItem">
                                    <li role="presentation"><a role="menuitem" tabindex="-1" href="add-supplier.php">Add New Supplier</a></li>
                                     <li role="presentation"><a role="menuitem" tabindex="-1" href="manage-suppliers.php">Manage Suppliers</a></li>
                                     <li role="presentation"><a role="menuitem" tabindex="-1" href="send-message-suppliers.php">Send Message</a></li>
                                     <li role="presentation"><a role="menuitem" tabindex="-1" href="manage-messages-suppliers.php">Manage Messages</a></li>
                                </ul>
                            </li>
                            
                             <li><a href="reg-students.php">Members</a></li>
                    
                            <li><a href="change-password.php">Change Password</a></li>
                            
                            <li>
                                <a href="#" class="dropdown-toggle" id="ddlmenuItem" data-toggle="dropdown"> Messages <i class="fa fa-angle-down"></i></a>
                                <ul class="dropdown-menu" role="menu" aria-labelledby="ddlmenuItem">
                                    <li role="presentation"><a role="menuitem" tabindex="-1" href="send_message.php">Send New Message</a></li>
